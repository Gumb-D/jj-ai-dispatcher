...
export const dispatchOutputSchema = z.object({
  ...
  taskId: z.string().optional().describe("Durable Dispatcher task ID allocated at acceptance time."),
...
export const runOutputSchema = z.object({
  ...
  acceptedAt: z.string().nullable().optional().describe("Acceptance timestamp when available."),
